...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/panel/immobilities/**").hasAnyRole("ADMIN", "REALTOR")
                .antMatchers("/panel/typeApplications/**").hasRole("ADMIN")
                .antMatchers("/panel/applications/**").hasAnyRole("ADMIN", "REALTOR")
                .antMatchers("/panel/deals/**").hasAnyRole("ADMIN", "REALTOR")
                .antMatchers("/panel/inspections/**").hasAnyRole("ADMIN", "REALTOR")
